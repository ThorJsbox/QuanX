...
!(async () => {
  ...
  console.log('京喜领88元红包\n' +
      ...
      '温馨提示：如提示助力火爆，可尝试寻找京东客服')
  let res = []
  res = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/ThorJsbox/QuanX/master/task_local/updateTeam/jd_jx88hb.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/ThorJsbox/QuanX@master/task_local/updateTeam/jd_jx88hb.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/ThorJsbox/QuanX@master/task_local/updateTeam/jd_jx88hb.json')
  }
