...
!(async () => {
  ...
  let res = await getAuthorShareCode('https://raw.githubusercontent.com/ThorJsbox/QuanX/master/task_local/updateTeam/jd_red.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/ThorJsbox/QuanX@master/task_local/updateTeam/jd_red.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/ThorJsbox/QuanX@master/task_local/updateTeam/jd_red.json')
  }
  let res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/ThorJsbox/QuanX/master/task_local/updateTeam/jd_red.json')  
  if (!res2) {
    await $.wait(1000)
    res2 = await getAuthorShareCode('https://ghproxy.com/https://raw.githubusercontent.com/ThorJsbox/QuanX/master/task_local/updateTeam/jd_red.json')
  }
