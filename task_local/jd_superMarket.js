...
//新版东东超市
function updatePkActivityId(url = 'https://ghproxy.com/https://raw.githubusercontent.com/ThorJsbox/QuanX/master/task_local/updateTeam/jd_updateSuperMarketCode..json') {
  return new Promise(resolve => {
...
async function barGain() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/Aaronlv/updateTeam/master/shareCodes/jd_barGain.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/Aaronlv/updateTeam@master/shareCodes/jd_barGain.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/Aaronlv/updateTeam@master/shareCodes/jd_barGain.json')
  }
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://ghproxy.com/https://raw.githubusercontent.com/ThorJsbox/QuanX/master/task_local/updateTeam/bigWinner.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/ThorJsbox/QuanX@master/task_local/updateTeam/bigWinner.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/ThorJsbox/QuanX@master/task_local/updateTeam/bigWinner.json')
  }
